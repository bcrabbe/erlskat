...
const App = () => {
  ...
  // New state for game value details
  const [gameValueDetails, setGameValueDetails] = useState(null);
  ...
  const renderGameValueWorking = (gameValueDetails, gameResult) => {
      ...
      {scoresModal ? (
        <div className="scores-modal-overlay">
          <div className="scores-modal">
            ...
            {gameValueDetails && renderGameValueWorking(gameValueDetails, lastGameResult)}
            <h3>Scoreboard</h3>
